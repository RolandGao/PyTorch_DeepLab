...
def rand_augment_both(im, mask,magnitude, ops=None, n_ops=2, prob=1.0,fill=(128,128,128),ignore_value=255):
...
if __name__=="__main__":
    im=Image.open("prima_4class/Images/pc-00000085.jpg")
    w, h = im.size[0], im.size[1]
    im=im.resize((w//4,h//4))
    output=visualize_ops(im,num_steps=10)
    #output=visualize_aug(im,magnitude=1/3)
    output.show()
